...
export default function RealisationsPage() {
  return (
    <div className="pt-24 pb-16">
      {/* Hero */}
      <div className="bg-white border-b border-gray-100 py-16 mb-14">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-[11px] font-bold tracking-[0.15em] uppercase text-[#0F2C5E]/40 mb-4">Nos chantiers</p>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0F2C5E] mb-5" style={{ fontFamily: "var(--font-playfair), serif" }}>
            Nos <span className="inline-block bg-[#0F2C5E] text-white px-3 py-1 rounded-sm">Réalisations</span>
          </h1>
          ...
          {realisations.map((r) => (
            <div key={r.titre} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-lg transition-shadow group">
              ...
              <div className="h-48 bg-gradient-to-br from-[#0F2C5E]/80 to-[#1a3f7a] flex items-center justify-center relative">
                ...
                <span className="absolute top-3 right-3 bg-[#0F2C5E] text-white text-xs font-semibold px-2.5 py-1 rounded-full">{r.cat}</span>
