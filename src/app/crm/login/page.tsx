          ...
          <div className="p-8">
            ...
            {tab === "login" ? (
              <form onSubmit={login} className="space-y-4">
                ...
                <button type="button" onClick={() => { setTab("setup"); setError(""); setMsg("") }}
              ...
              <form onSubmit={sendSetup} className="space-y-4">
                <p className="text-sm text-gray-500">Entrez votre email pour recevoir un lien de configuration de mot de passe.</p>
                <div>
