    ...
    <div className="relative">
      ...
      <div className="absolute bottom-4 left-4 z-[1000] bg-white rounded-xl shadow-lg p-3 text-xs space-y-1.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600">Zone proche (&lt; 20 km)</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-[#0F2C5E] inline-block" />
          <span className="text-gray-600">Zone intermédiaire (20–45 km)</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-gray-500 inline-block" />
          <span className="text-gray-600">Zone étendue (45–80 km)</span>
        </div>
      </div>
    </div>
  )
