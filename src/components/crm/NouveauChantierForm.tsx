  ...
  return (
    <form onSubmit={submit} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-5">
      ...
      <button type="submit" disabled={loading}
        className="w-full bg-[#0F2C5E] text-white font-semibold py-3 rounded-xl hover:bg-[#1a3f7a] transition-colors disabled:opacity-60 flex items-center justify-center gap-2">
