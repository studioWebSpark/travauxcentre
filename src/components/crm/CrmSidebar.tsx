  ...
  return (
    <aside className="w-56 shrink-0 bg-[#0F2C5E] min-h-screen flex-col hidden lg:flex">
      ...
      <div className="px-5 py-5 border-b border-white/10">
        ...
        <p className="text-slate-500 text-xs mt-1 ml-10 font-montserrat">CRM</p>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        ...
        {xp.next && (
          <p className="text-xs text-slate-600 mt-1 truncate font-montserrat">{xp.next.min - xp.totalXp} XP → {xp.next.label}</p>
        )}
      </div>
